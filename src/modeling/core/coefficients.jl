...
function _create_field_coefficient_cache(coefficient::FieldCoefficient, ipc::ScalarInterpolationCollection, qr::QuadratureRule{<:Any, <:AbstractArray{T}}, sdh::SubDofHandler) where T
...
function _create_field_coefficient_cache(coefficient::FieldCoefficient, ipc::VectorizedInterpolationCollection, qr::QuadratureRule{<:Any, <:AbstractArray{T}}, sdh::SubDofHandler) where T
    cell = get_first_cell(sdh)
    ip     = getinterpolation(coefficient.ip_collection, cell)
