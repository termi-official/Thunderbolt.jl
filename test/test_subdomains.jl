@testset "Subdomains" begin
    ...
    # Dummy writers
    io = ParaViewWriter("")
    ioJLD2 = JLD2Writer("", 0) # This is wrong, it's not intended to call the constructor but to create a dummy object for testing.
    ...
    # @test_throws subdomain_error Thunderbolt.QuasiStaticODEProblem(dh, ch, qsm, [])
    # @test_throws subdomain_error Thunderbolt.QuasiStaticDAEProblem(dh, ch, qsm, [])
