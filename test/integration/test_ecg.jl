@testset "ECG" begin
    @testset "Blocks with $geo" for geo in (Hexahedron, Tetrahedron)
        ...
        #     VertexIndex(213,1)=> VertexIndex(6,1),
        #     VertexIndex(124,1)=> VertexIndex(534,1),
        # )
        geselowitz_ecg = Thunderbolt.Geselowitz1989ECGLeadCache(torso_grid, ConstantCoefficient(κᵢ), ConstantCoefficient(κ), Tuple(geselowitz_electrodes))
